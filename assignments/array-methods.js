...
// Problem 1
// Judges need all runners Whose name starts with A
let aRunners = runners.filter(runner => runner.first_name[0] === 'A');
console.log(aRunners);

// Problem 2
// The judges need all runners emails to send out updated info for the run
